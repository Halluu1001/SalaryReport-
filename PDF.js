  ...
  return (
   ...
   <Card className={classes.root} >
      ...
      <div className="Post" ref={ref}>
        ...
        <h5 style={{fontWeight:'400', marginBottom: '40px', marginLeft:'450px', marginTop: '-98px'}}>+91 9500601772</h5>
        <h5 style={{fontWeight:'400', marginBottom: '40px' ,marginLeft:'450px', marginTop: '-30px'}}>www.rubixtek.com</h5>
      ...
      <Pdf targetRef={ref} filename="Receipt.pdf">
        {({ toPdf }) => <Button size="small" style={{backgroundColor: '#561571', color: '#FFFFFF', float: 'right',marginTop: -600, marginRight: 50}} onClick={toPdf}>Generate Receipt</Button>}
      </Pdf>
    </>
  );
}
